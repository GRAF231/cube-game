    ...
    if (typeof YaGames !== 'undefined') {
      YaGames
        ...
        .catch((error) => {
          ...
          this.statusText.setText('Ошибка инициализации SDK. Игра продолжится без интеграции.');
      ...
      this.statusText.setText('SDK Яндекс.Игр не обнаружен. Игра запущена в локальном режиме.');
