...
export class MenuScene extends BaseScene {
    ...
    create(): void {
        ...
        const midLayer = this.add
            .rectangle(0, GAME_HEIGHT / 2 - 150, GAME_WIDTH, 300, 0x2d2b55, 0.7)
            .setOrigin(0);
        ...
        this.add
            .text(GAME_WIDTH / 2, 220, `Привет, ${this.playerName}!`, {
                fontFamily: 'Arial',
                fontSize: '24px',
                color: '#ffffff',
            })
        ...
        const playButton = this.createTextButton(GAME_WIDTH / 2, buttonY, 'Играть', () => {
        ...
        this.add
            .text(GAME_WIDTH - 10, GAME_HEIGHT - 10, 'Версия 1.0.0', {
                fontFamily: 'Arial',
                fontSize: '14px',
                color: '#95a5a6',
            })
